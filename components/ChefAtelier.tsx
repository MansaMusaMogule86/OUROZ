    ...
    <div className="animate-fade-in pt-12 space-y-20">
      ...
      <div className="relative rounded-[64px] overflow-hidden bg-emerald h-[650px] shadow-luxury group border border-emerald/20 mx-2">
        <img 
          ...
          className="w-full h-full object-cover opacity-30 group-hover:scale-105 transition-transform duration-[4s] grayscale-[0.2]"
          alt="Chef Adafer Atelier"
        />
        <div className="absolute inset-0 flex flex-col justify-center items-center text-sahara text-center p-12 space-y-12">
          ...
          <p className="text-3xl max-w-3xl font-serif font-light italic leading-relaxed opacity-90">
          ...
          <div className="flex flex-col md:flex-row gap-10 pt-8">
             ...
             <button className="px-16 py-7 glass-vogue text-sahara rounded-full font-black text-[11px] uppercase tracking-[0.5em] border-emerald/40 hover:bg-emerald/20 transition-all">
               View Apothecary
             </button>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-16 px-4">
        {[
          ...
          <div key={i} className="group card-vogue glass-vogue p-12 hover:-translate-y-6 transition-all duration-1000 cursor-pointer border-emerald/10 hover:border-emerald/40 bg-white/5">
