...
const OrderManagement: React.FC<OrderManagementProps> = ({ language, userId, userType, onNavigate }) => {
    ...
    // Memoize the filtered orders to prevent recalculation on every render (e.g., typing in search)
    // Performance: Avoids O(N) filtering operations on unrelated state changes
...
// Memoized to prevent unnecessary re-renders when filtering or searching
// Performance: Reduces render cycles by only updating cards that change
