    ...
    return (
        <div className="w-full max-w-md space-y-8">
            <div className="text-center">
                ...
                <h1 className="mt-6 text-3xl font-bold text-[var(--color-charcoal)]">Welcome back</h1>
                <p className="mt-2 text-sm text-[var(--color-charcoal)]/60">Sign in to your account to continue</p>
            </div>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm"><span className="px-4 bg-[var(--color-sahara)] text-[var(--color-charcoal)]/40">or sign in with email</span></div>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                    <div className="flex items-center justify-between mb-1">
                        <label htmlFor="password" className="block text-sm font-medium text-[var(--color-charcoal)]/70">Password</label>
                        <Link href="/auth/password-reset" className="text-sm text-amber-600 hover:text-amber-700">Forgot password?</Link>
                    </div>
            ...
            <p className="text-center text-sm text-[var(--color-charcoal)]/50">
                ...
                <Link href={`/auth/signup?return=${encodeURIComponent(returnTo)}`} className="text-amber-600 font-medium hover:text-amber-700">
                    Create one
                </Link>
            </p>
        </div>
